...
@synthesize headacheBtn, stomachBtn, cutBtn;
...
- (IBAction)headache:(id)sender {
	[self zoomIn:sender interaction:@"headache"];
}

- (IBAction)stomach:(id)sender {
	[self zoomIn:sender interaction:@"stomach"];
}

- (IBAction)cut:(id)sender {
	[self zoomIn:sender interaction:@"cut"];
}
